...
--------------------------------------------------------
  ...
  ALTER TABLE "HUNDISILM"."B_CHECKS" ADD CONSTRAINT "B_CHECKS#CHK_TYPE#LOV" CHECK ("CHK_TYPE"='MIN' OR "CHK_TYPE"='MAX' OR "CHK_TYPE"='LOV' OR "CHK_TYPE"='LOV_EXCL' OR "CHK_TYPE"='FUNCTION' OR "CHK_TYPE"='RPREDICT') ENABLE;
