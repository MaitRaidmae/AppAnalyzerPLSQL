...
lc_sql :='select scc_code,scc_apl_code,scc_value,scc_srn_code
...
(
scc_apl_code,scc_value,scc_srn_code
)
VALUES
(
par_scc_apl_code, par_scc_value, par_scc_srn_code
);
END INSERT_ROW;
-----------------------------------------------------------------------------
